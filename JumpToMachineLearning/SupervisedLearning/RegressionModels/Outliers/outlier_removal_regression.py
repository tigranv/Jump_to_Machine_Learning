...
ages = pickle.load( open("../JumpToMachineLearning/AppData/practice_outliers_ages.pkl", "rb") )
net_worths = pickle.load( open("../JumpToMachineLearning/AppData/practice_outliers_net_worths.pkl", "rb") )
